 ...
 <section>
	    	...
	    	<?php if(isset($stop)){
				...
				<form role="form" method="post" action="" autocomplete="off">
					...
					<div class="log-input">
								<div class="log-input-left">
								<input type="password" name="passwordConfirm" id="passwordConfirm" class=" " placeholder="Confirm Password"  >
							</div>
						</div>
					 
					
				<div class="new_people"><input type="submit" name="submit" value="Change Password" class=" "  ></div>
					</div>
				</form>
