 ...
 <section>
			...
			<form role="form" method="post" action="" autocomplete="off">
				...
				<div class="log-input">
					...
					<br><input type="text" name="email" id="email" class="user" placeholder="Email" value="" ><br>
				</div>

				<div class="row">
					<div class="new_people"><input type="submit" name="submit" value="Sent Reset Link" class="" ></div>
				</div>
			</form>
		</div>
	</div>
